...
describe Statistik::Mock do  
  ...
  it 'should include comparison and school using param :school_id => 123' do
    mock = Statistik::Mock.find 1234, school_id: 123
    
    mock.comparison.should be_instance_of Array
    mock.school.should be_instance_of Array
    ...
    mock.school.school_id.should == 1
